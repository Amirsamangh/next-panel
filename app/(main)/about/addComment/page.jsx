...
const page = () => {
    return (
        <div className="animate-fade fixed w-full h-screen top-0 left-0 bg-[#ffffffff] flex items-center justify-center">
            <form className="w-1/3 bg-white rounded-lg p-5 shadow-2xl">
                ...
                <Link href={'/about'}>
                    <button type="button" className="px-5 py-3 rounded-full w-full mt-5 bg-cyan-500 hover:bg-cyan-600 transition-all cursor-pointer text-white">ثبت نظر</button>
                </Link>
            </form>
        </div>
    )
